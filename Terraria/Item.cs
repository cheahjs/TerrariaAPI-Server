...
namespace Terraria
{
	public class Item
	{
		...
		public static int[] headType = new int[145];
		public static int[] bodyType = new int[105];
		public static int[] legType = new int[88];
		public bool flame;
		public bool mech;
		public bool wet;
		...
		public void SetDefaults(int Type, bool noMatCheck = false)
		{
			...
			else if (this.type == 52 || this.type == 673 || this.type == 677 || this.type == 858)
			{
				this.type = 52;
			...
			else if (this.type >= 1615 && this.type <= 1701)
			{
			...
			else if (this.type >= 1703 && this.type <= 1708)
			{
				this.name = "Chair";
				this.useStyle = 1;
				this.useTurn = true;
			...
			else if (this.type >= 1709 && this.type <= 1712)
			{
				this.name = "Door";
				this.useStyle = 1;
				this.useTurn = true;
			...
			else if (this.type >= 1713 && this.type <= 1718)
			{
				this.name = "Table";
				this.useStyle = 1;
				this.useTurn = true;
			...
			else if (this.type >= 1719 && this.type <= 1722)
			{
				this.name = "Bed";
				this.useStyle = 1;
				this.useTurn = true;
			...
			else if (this.type == 1867)
			{
				this.name = "Candy Cane";
				this.width = 12;
				this.height = 12;
			}
			else if (this.type == 1868)
			{
				this.name = "Sugar Plum";
				this.width = 12;
				this.height = 12;
			}
			else if (this.type == 1869)
			{
				this.name = "Present";
				this.useStyle = 1;
				this.useTurn = true;
			...
			else if (this.type >= 1874 && this.type <= 1905)
			{
			...
			else if (this.type == 1922)
			{
				this.name = "Coal";
				this.width = 16;
				this.height = 24;
			}
			else if (this.type == 1923)
			{
				this.name = "Toolbox";
				this.width = 16;
				this.height = 24;
			...
			else if (this.type >= 1948 && this.type <= 1957)
			{
				...
				this.maxStack = 999;
				this.consumable = true;
				this.createWall = 116 + this.type - 1948;
				this.width = 12;
				this.height = 12;
				this.value = Item.buyPrice(0, 0, 1, 0);
			}
			else if (this.type == 1958)
			{
				this.useStyle = 4;
			...
			else if (this.type == 1960 || this.type == 1961 || this.type == 1962)
			{
				this.name = "Trophy";
				this.useStyle = 1;
				this.useTurn = true;
				...
				this.value = Item.sellPrice(0, 1, 0, 0);
				this.rare = 1;
				this.placeStyle = 38 + this.type - 1960;
			}
			else if (this.type == 1963)
			{
