						...
						case 5:
							{
								...
								if (number2 < 59f)
								{
									if (Main.player[number].inventory[(int)number2].name == "" ||
										Main.player[number].inventory[(int)number2].stack == 0 ||
										Main.player[number].inventory[(int)number2].type == 0)
									{
								...
								else
								{
									if (number2 >= 70f && number2 <= 72f)
									{
										...
										if (Main.player[number].dye[num5].name == "" || Main.player[number].dye[num5].stack == 0 ||
											Main.player[number].dye[num5].type == 0)
										{
									...
									{
										if (Main.player[number].armor[(int)number2 - 58 - 1].name == "" ||
											Main.player[number].armor[(int)number2 - 58 - 1].stack == 0 ||
											Main.player[number].armor[(int)number2 - 58 - 1].type == 0)
										{
						...
						case 10:
							{
								...
								for (int i = num7; i < num7 + (int)num6; i++)
								{
									...
									byte[] bytes50 = BitConverter.GetBytes(tile.frameX);
									byte[] bytes51 = BitConverter.GetBytes(tile.frameY);
									byte wall = tile.wall;
									if (tile.active())
									{
										NetMessage.buffer[num].writeBuffer[num3] = tile.type;
										num3++;
									...
									if (tile.liquid > 0)
									{
										NetMessage.buffer[num].writeBuffer[num3] = tile.liquid;
										num3++;
										byte b34 = tile.liquidType();
										NetMessage.buffer[num].writeBuffer[num3] = b34;
										num3++;
									}
									short num9 = 1;
									while (i + (int)num9 < num7 + (int)num6 &&
										   tile.isTheSameAs(Main.tile[i + (int)num9, num8]))
									{
										num9 += 1;
									}
									num9 -= 1;
						...
						case 20:
							{
								...
								for (int j = num11; j < num11 + (int)num10; j++)
								{
									for (int k = num12; k < num12 + (int)num10; k++)
									{
										...
										byte[] bytes95 = BitConverter.GetBytes(tile.frameX);
										byte[] bytes96 = BitConverter.GetBytes(tile.frameY);
										byte wall2 = tile.wall;
										if (tile.active())
										{
											NetMessage.buffer[num].writeBuffer[num3] = tile.type;
											num3++;
						...
						case 21:
							{
								...
								num2 += bytes99.Length + bytes100.Length + bytes101.Length + bytes102.Length + bytes103.Length +
										1 + bytes105.Length + 1 + 1 + 1;
						...
						case 23:
							{
								...
								num2 += bytes111.Length + bytes112.Length + bytes113.Length + bytes114.Length +
										bytes115.Length + 1 + bytes116.Length + NPC.maxAI * 4 + bytes117.Length + 1 + 1;
						...
						case 29:
							{
								...
								Buffer.BlockCopy(bytes147, 0, NetMessage.buffer[num].writeBuffer, num3,
									bytes147.Length);
								num3 += 2;
						...
						case 31:
							{
								...
								Buffer.BlockCopy(bytes152, 0, NetMessage.buffer[num].writeBuffer, num3,
									bytes152.Length);
								num3 += 4;
								Buffer.BlockCopy(bytes153, 0, NetMessage.buffer[num].writeBuffer, num3,
									bytes153.Length);
							}
							break;
						case 32:
							{
								...
								byte[] bytes157 =
									BitConverter.GetBytes(Main.chest[number].item[(int)number2].stack);
								...
								{
									bytes158 =
										BitConverter.GetBytes((short)Main.chest[number].item[(int)number2].netID);
								}
								...
								Buffer.BlockCopy(bytes156, 0, NetMessage.buffer[num].writeBuffer, num3,
									bytes156.Length);
								num3 += 2;
								NetMessage.buffer[num].writeBuffer[num3] = b71;
								num3++;
								Buffer.BlockCopy(bytes157, 0, NetMessage.buffer[num].writeBuffer, num3,
									bytes157.Length);
								num3 += 2;
								NetMessage.buffer[num].writeBuffer[num3] = prefix2;
								num3++;
								Buffer.BlockCopy(bytes158, 0, NetMessage.buffer[num].writeBuffer, num3,
									bytes158.Length);
							}
							break;
						case 33:
							{
								...
								Buffer.BlockCopy(bytes161, 0, NetMessage.buffer[num].writeBuffer, num3,
									bytes161.Length);
								num3 += 2;
								Buffer.BlockCopy(bytes162, 0, NetMessage.buffer[num].writeBuffer, num3,
									bytes162.Length);
								num3 += 4;
								Buffer.BlockCopy(bytes163, 0, NetMessage.buffer[num].writeBuffer, num3,
									bytes163.Length);
							}
							break;
						case 34:
							{
								...
								Buffer.BlockCopy(bytes166, 0, NetMessage.buffer[num].writeBuffer, num3,
									bytes166.Length);
								num3 += 4;
								Buffer.BlockCopy(bytes167, 0, NetMessage.buffer[num].writeBuffer, num3,
									bytes167.Length);
							}
							break;
						case 66:
						...
						case 38:
							{
								...
								Buffer.BlockCopy(bytes177, 0, NetMessage.buffer[num].writeBuffer, num3,
									bytes177.Length);
							}
							break;
						case 39:
							{
								...
								Buffer.BlockCopy(bytes180, 0, NetMessage.buffer[num].writeBuffer, num3,
									bytes180.Length);
							}
							break;
						case 40:
							{
								...
								byte[] bytes183 =
									BitConverter.GetBytes((short)Main.player[(int)b75].talkNPC);
								...
								num3++;
								Buffer.BlockCopy(bytes183, 0, NetMessage.buffer[num].writeBuffer, num3,
									bytes183.Length);
								num3 += 2;
							}
							break;
						case 41:
							{
								...
								byte[] bytes186 =
									BitConverter.GetBytes(Main.player[(int)b76].itemRotation);
								byte[] bytes187 =
									BitConverter.GetBytes((short)Main.player[(int)b76].itemAnimation);
								...
								num3++;
								Buffer.BlockCopy(bytes186, 0, NetMessage.buffer[num].writeBuffer, num3,
									bytes186.Length);
								num3 += 4;
								Buffer.BlockCopy(bytes187, 0, NetMessage.buffer[num].writeBuffer, num3,
									bytes187.Length);
							}
							break;
						case 42:
							{
								...
								byte[] bytes190 =
									BitConverter.GetBytes((short)Main.player[(int)b77].statMana);
								byte[] bytes191 =
									BitConverter.GetBytes((short)Main.player[(int)b77].statManaMax);
						...
						case 43:
							{
								...
								num3++;
								Buffer.BlockCopy(bytes194, 0, NetMessage.buffer[num].writeBuffer, num3,
									2);
							}
							break;
						case 44:
							{
								...
								num3++;
								Buffer.BlockCopy(bytes197, 0, NetMessage.buffer[num].writeBuffer, num3,
									bytes197.Length);
								num3 += 2;
								NetMessage.buffer[num].writeBuffer[num3] = b81;
								num3++;
								Buffer.BlockCopy(bytes198, 0, NetMessage.buffer[num].writeBuffer, num3,
									bytes198.Length);
						...
						case 46:
							{
								...
								Buffer.BlockCopy(bytes205, 0, NetMessage.buffer[num].writeBuffer, 0,
									4);
								Buffer.BlockCopy(bytes202, 0, NetMessage.buffer[num].writeBuffer, 4,
									1);
								Buffer.BlockCopy(bytes203, 0, NetMessage.buffer[num].writeBuffer,
									num3, bytes203.Length);
								num3 += 4;
								Buffer.BlockCopy(bytes204, 0, NetMessage.buffer[num].writeBuffer,
						...
						case 47:
							{
								...
								num2 += bytes207.Length + bytes208.Length + bytes209.Length +
										bytes210.Length;
								byte[] bytes211 = BitConverter.GetBytes(num2 - 4);
								Buffer.BlockCopy(bytes211, 0, NetMessage.buffer[num].writeBuffer, 0,
									4);
								Buffer.BlockCopy(bytes206, 0, NetMessage.buffer[num].writeBuffer, 4,
									1);
								Buffer.BlockCopy(bytes207, 0, NetMessage.buffer[num].writeBuffer,
									num3, bytes207.Length);
								num3 += bytes207.Length;
								Buffer.BlockCopy(bytes208, 0, NetMessage.buffer[num].writeBuffer,
									num3, bytes208.Length);
								num3 += bytes208.Length;
								Buffer.BlockCopy(bytes209, 0, NetMessage.buffer[num].writeBuffer,
									num3, bytes209.Length);
								num3 += bytes209.Length;
								Buffer.BlockCopy(bytes210, 0, NetMessage.buffer[num].writeBuffer,
						...
						case 48:
							{
								...
								Buffer.BlockCopy(bytes215, 0, NetMessage.buffer[num].writeBuffer, 0,
									4);
								Buffer.BlockCopy(bytes212, 0, NetMessage.buffer[num].writeBuffer, 4,
									1);
								Buffer.BlockCopy(bytes213, 0, NetMessage.buffer[num].writeBuffer,
									num3, 4);
								num3 += 4;
								Buffer.BlockCopy(bytes214, 0, NetMessage.buffer[num].writeBuffer,
									num3, 4);
								num3 += 4;
						...
						case 49:
							{
								...
								Buffer.BlockCopy(bytes217, 0, NetMessage.buffer[num].writeBuffer,
									0, 4);
								Buffer.BlockCopy(bytes216, 0, NetMessage.buffer[num].writeBuffer,
									4, 1);
							}
							break;
						case 50:
						...
						case 51:
							{
								...
								Buffer.BlockCopy(bytes221, 0, NetMessage.buffer[num].writeBuffer,
									0, 4);
								Buffer.BlockCopy(bytes220, 0, NetMessage.buffer[num].writeBuffer,
									4, 1);
						...
						case 52:
							{
								...
								Buffer.BlockCopy(bytes225, 0,
									NetMessage.buffer[num].writeBuffer, 0, 4);
								Buffer.BlockCopy(bytes222, 0,
									NetMessage.buffer[num].writeBuffer, 4, 1);
								NetMessage.buffer[num].writeBuffer[num3] = b88;
								num3++;
								NetMessage.buffer[num].writeBuffer[num3] = b89;
								num3++;
								Buffer.BlockCopy(bytes223, 0,
									NetMessage.buffer[num].writeBuffer, num3, 4);
								num3 += 4;
								Buffer.BlockCopy(bytes224, 0,
									NetMessage.buffer[num].writeBuffer, num3, 4);
								num3 += 4;
							}
							break;
						case 53:
							{
								...
								Buffer.BlockCopy(bytes229, 0,
									NetMessage.buffer[num].writeBuffer, 0, 4);
								Buffer.BlockCopy(bytes226, 0,
									NetMessage.buffer[num].writeBuffer, 4, 1);
								Buffer.BlockCopy(bytes227, 0,
									NetMessage.buffer[num].writeBuffer, num3, bytes227.Length);
								num3 += bytes227.Length;
								NetMessage.buffer[num].writeBuffer[num3] = b90;
								num3++;
								Buffer.BlockCopy(bytes228, 0,
									NetMessage.buffer[num].writeBuffer, num3, bytes228.Length);
						...
						case 54:
							{
								...
								Buffer.BlockCopy(bytes232, 0,
									NetMessage.buffer[num].writeBuffer, 0, 4);
								Buffer.BlockCopy(bytes230, 0,
									NetMessage.buffer[num].writeBuffer, 4, 1);
								Buffer.BlockCopy(bytes231, 0,
									NetMessage.buffer[num].writeBuffer, num3, bytes231.Length);
								num3 += bytes231.Length;
								for (int num13 = 0; num13 < 5; num13++)
								{
									NetMessage.buffer[num].writeBuffer[num3] =
										(byte)Main.npc[(int)((short)number)].buffType[num13];
									num3++;
									byte[] bytes233 =
										BitConverter.GetBytes(
											Main.npc[(int)((short)number)].buffTime[num13]);
									Buffer.BlockCopy(bytes233, 0,
										NetMessage.buffer[num].writeBuffer, num3, bytes233.Length);
						...
						case 55:
							{
								...
								Buffer.BlockCopy(bytes236, 0,
									NetMessage.buffer[num].writeBuffer, 0, 4);
								Buffer.BlockCopy(bytes234, 0,
									NetMessage.buffer[num].writeBuffer, 4, 1);
								NetMessage.buffer[num].writeBuffer[num3] = b91;
								num3++;
								NetMessage.buffer[num].writeBuffer[num3] = b92;
								num3++;
								Buffer.BlockCopy(bytes235, 0,
									NetMessage.buffer[num].writeBuffer, num3, bytes235.Length);
						...
						case 56:
							{
								...
								byte[] bytes239 =
									Encoding.UTF8.GetBytes(Main.chrName[number]);
								num2 += bytes238.Length + bytes239.Length;
								byte[] bytes240 = BitConverter.GetBytes(num2 - 4);
								Buffer.BlockCopy(bytes240, 0,
									NetMessage.buffer[num].writeBuffer, 0, 4);
								Buffer.BlockCopy(bytes237, 0,
									NetMessage.buffer[num].writeBuffer, 4, 1);
								Buffer.BlockCopy(bytes238, 0,
									NetMessage.buffer[num].writeBuffer, num3, bytes238.Length);
								num3 += bytes238.Length;
								Buffer.BlockCopy(bytes239, 0,
									NetMessage.buffer[num].writeBuffer, num3, bytes239.Length);
							}
							break;
						case 57:
							{
								...
								Buffer.BlockCopy(bytes242, 0,
									NetMessage.buffer[num].writeBuffer, 0, 4);
								Buffer.BlockCopy(bytes241, 0,
									NetMessage.buffer[num].writeBuffer, 4, 1);
						...
						case 58:
							{
								...
								Buffer.BlockCopy(bytes245, 0,
									NetMessage.buffer[num].writeBuffer, 0, 4);
								Buffer.BlockCopy(bytes243, 0,
									NetMessage.buffer[num].writeBuffer, 4, 1);
								NetMessage.buffer[num].writeBuffer[num3] = b93;
								num3++;
								Buffer.BlockCopy(bytes244, 0,
									NetMessage.buffer[num].writeBuffer, num3,
									bytes244.Length);
							}
							break;
						case 59:
							{
								...
								Buffer.BlockCopy(bytes249, 0,
									NetMessage.buffer[num].writeBuffer, 0, 4);
								Buffer.BlockCopy(bytes246, 0,
									NetMessage.buffer[num].writeBuffer, 4, 1);
								Buffer.BlockCopy(bytes247, 0,
									NetMessage.buffer[num].writeBuffer, num3,
									bytes247.Length);
								num3 += 4;
								Buffer.BlockCopy(bytes248, 0,
									NetMessage.buffer[num].writeBuffer, num3,
									bytes248.Length);
							}
							break;
						case 60:
							{
								...
								num2 += bytes251.Length + bytes252.Length +
										bytes253.Length + 1;
								byte[] bytes254 = BitConverter.GetBytes(num2 - 4);
								Buffer.BlockCopy(bytes254, 0,
									NetMessage.buffer[num].writeBuffer, 0, 4);
								Buffer.BlockCopy(bytes250, 0,
									NetMessage.buffer[num].writeBuffer, 4, 1);
								Buffer.BlockCopy(bytes251, 0,
									NetMessage.buffer[num].writeBuffer, num3,
									bytes251.Length);
								num3 += 2;
								Buffer.BlockCopy(bytes252, 0,
									NetMessage.buffer[num].writeBuffer, num3,
									bytes252.Length);
								num3 += 2;
								Buffer.BlockCopy(bytes253, 0,
									NetMessage.buffer[num].writeBuffer, num3,
									bytes253.Length);
								num3 += 2;
						...
						case 61:
							{
								...
								Buffer.BlockCopy(bytes258, 0,
									NetMessage.buffer[num].writeBuffer, 0, 4);
								Buffer.BlockCopy(bytes255, 0,
									NetMessage.buffer[num].writeBuffer, 4, 1);
								Buffer.BlockCopy(bytes256, 0,
									NetMessage.buffer[num].writeBuffer, num3,
									bytes256.Length);
								num3 += bytes256.Length;
								Buffer.BlockCopy(bytes257, 0,
									NetMessage.buffer[num].writeBuffer, num3,
									bytes257.Length);
							}
							break;
						case 62:
							{
								...
								Buffer.BlockCopy(bytes262, 0,
									NetMessage.buffer[num].writeBuffer, 0, 4);
								Buffer.BlockCopy(bytes259, 0,
									NetMessage.buffer[num].writeBuffer, 4, 1);
								Buffer.BlockCopy(bytes260, 0,
									NetMessage.buffer[num].writeBuffer, num3,
									bytes260.Length);
								num3 += bytes260.Length;
								Buffer.BlockCopy(bytes261, 0,
									NetMessage.buffer[num].writeBuffer, num3,
									bytes261.Length);
							}
							break;
						case 63:
							{
								...
								byte[] bytes265 =
									BitConverter.GetBytes((int)number2);
								byte b95 = (byte)number3;
								num2 += bytes264.Length + bytes265.Length + 1;
								byte[] bytes266 = BitConverter.GetBytes(num2 - 4);
								Buffer.BlockCopy(bytes266, 0,
									NetMessage.buffer[num].writeBuffer, 0, 4);
								Buffer.BlockCopy(bytes263, 0,
									NetMessage.buffer[num].writeBuffer, 4, 1);
								Buffer.BlockCopy(bytes264, 0,
									NetMessage.buffer[num].writeBuffer, num3,
									bytes264.Length);
								num3 += bytes264.Length;
								Buffer.BlockCopy(bytes265, 0,
									NetMessage.buffer[num].writeBuffer, num3,
									bytes265.Length);
						...
						case 64:
							{
								...
								Buffer.BlockCopy(bytes270, 0,
									NetMessage.buffer[num].writeBuffer, 0, 4);
								Buffer.BlockCopy(bytes267, 0,
									NetMessage.buffer[num].writeBuffer, 4, 1);
								Buffer.BlockCopy(bytes268, 0,
									NetMessage.buffer[num].writeBuffer, num3,
									bytes268.Length);
								num3 += bytes268.Length;
								Buffer.BlockCopy(bytes269, 0,
									NetMessage.buffer[num].writeBuffer, num3,
									bytes269.Length);
						...
						case 65:
							{
								...
								byte b97 = 0;
								byte[] bytes272 =
									BitConverter.GetBytes((short)number2);
								...
								num2 += 1 + bytes272.Length + bytes273.Length +
										bytes274.Length;
								byte[] bytes275 = BitConverter.GetBytes(num2 - 4);
								Buffer.BlockCopy(bytes275, 0,
									NetMessage.buffer[num].writeBuffer, 0, 4);
								Buffer.BlockCopy(bytes271, 0,
									NetMessage.buffer[num].writeBuffer, 4, 1);
								NetMessage.buffer[num].writeBuffer[num3] = b97;
								num3++;
								Buffer.BlockCopy(bytes272, 0,
									NetMessage.buffer[num].writeBuffer, num3,
									bytes272.Length);
								num3 += bytes272.Length;
								Buffer.BlockCopy(bytes273, 0,
									NetMessage.buffer[num].writeBuffer, num3,
									bytes273.Length);
								num3 += bytes273.Length;
								Buffer.BlockCopy(bytes274, 0,
									NetMessage.buffer[num].writeBuffer, num3,
									bytes274.Length);
				...
				IL_4EA4:
					if (remoteClient == -1)
					{
						if (msgType == 20)
						{
							...
							{
								if (num16 != ignoreClient &&
									(NetMessage.buffer[num16].broadcast || (Netplay.serverSock[num16].state >= 3 && msgType == 10)) &&
									Netplay.serverSock[num16].tcpClient.Connected &&
									Netplay.serverSock[num16].SectionRange(number, (int)number2, (int)number3))
								{
									try
									{
						...
						if (msgType == 23)
						{
							...
							{
								if (num17 != ignoreClient &&
									(NetMessage.buffer[num17].broadcast || (Netplay.serverSock[num17].state >= 3 && msgType == 10)) &&
									Netplay.serverSock[num17].tcpClient.Connected)
								{
									...
									else
									{
										...
										{
											Rectangle rectangle = new Rectangle((int)Main.player[num17].position.X, (int)Main.player[num17].position.Y,
												Main.player[num17].width, Main.player[num17].height);
											Rectangle value2 = new Rectangle((int)Main.npc[number].position.X, (int)Main.npc[number].position.Y,
												Main.npc[number].width, Main.npc[number].height);
											value2.X -= 2500;
											value2.Y -= 2500;
											value2.Width += 5000;
											value2.Height += 5000;
						...
						else
						{
							if (msgType == 28)
							{
								...
								{
									if (num18 != ignoreClient &&
										(NetMessage.buffer[num18].broadcast || (Netplay.serverSock[num18].state >= 3 && msgType == 10)) &&
										Netplay.serverSock[num18].tcpClient.Connected)
									{
										bool flag3 = false;
										...
										{
											Rectangle rectangle2 = new Rectangle((int)Main.player[num18].position.X, (int)Main.player[num18].position.Y,
												Main.player[num18].width, Main.player[num18].height);
											Rectangle value3 = new Rectangle((int)Main.npc[number].position.X, (int)Main.npc[number].position.Y,
												Main.npc[number].width, Main.npc[number].height);
											value3.X -= 3000;
											value3.Y -= 3000;
											value3.Width += 6000;
							...
							if (msgType == 13)
							{
								...
								{
									if (num19 != ignoreClient &&
										(NetMessage.buffer[num19].broadcast || (Netplay.serverSock[num19].state >= 3 && msgType == 10)) &&
										Netplay.serverSock[num19].tcpClient.Connected)
									{
										bool flag4 = true;
										if (flag4)
										{
									...
									for (int num20 = 0; num20 < 256; num20++)
									{
											...
											Netplay.serverSock[num20].tcpClient.Connected)
										{
											...
											if (Main.projectile[number].type == 12 || Main.projPet[Main.projectile[number].type] ||
												Main.projectile[number].aiStyle == 11 || Main.projPet[Main.projectile[number].type] ||
												Main.projectile[number].netImportant)
											{
												flag5 = true;
											}
											else
											{
												Rectangle rectangle3 = new Rectangle((int)Main.player[num20].position.X,
													(int)Main.player[num20].position.Y, Main.player[num20].width, Main.player[num20].height);
												Rectangle value4 = new Rectangle((int)Main.projectile[number].position.X,
													(int)Main.projectile[number].position.Y, Main.projectile[number].width, Main.projectile[number].height);
												value4.X -= 5000;
												value4.Y -= 5000;
												value4.Width += 10000;
												value4.Height += 10000;
